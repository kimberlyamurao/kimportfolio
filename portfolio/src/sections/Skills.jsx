...
const categories = [
  {
    ...
    skills: [
      { icon: CalendarDays, label: "Calendar Management", yrs: "2 yrs" },
      { icon: Mail, label: "Email Management", yrs: "" },
      { icon: FolderOpen, label: "Project Coordination", yrs: "" },
      { icon: FileText, label: "Document Management", yrs: "" },
      { icon: BookOpen, label: "Contract Preparation", yrs: "2 yrs" },
      { icon: Database, label: "Data Management", yrs: "" },
    ],
  },
  {
    title: "Finance",
    ...
    skills: [
      ...
      { icon: BarChart2, label: "Financial Reporting", yrs: "" },
      { icon: Users, label: "Payroll Support", yrs: "2 yrs" },
  ...
  },
  {
    ...
    skills: [
      { icon: Monitor, label: "Google Workspace", yrs: "2 yrs" },
      { icon: Monitor, label: "Microsoft Office", yrs: "2 yrs" },
      { icon: Table2, label: "QuickBooks", yrs: "" },
      { icon: Table2, label: "Zoho Books", yrs: "" },
      { icon: Table2, label: "Exact Online", yrs: "" },
      { icon: Table2, label: "Excel / Sheets", yrs: "" },
    ],
  },
];
